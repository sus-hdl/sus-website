...
Compiletime (`if`) conditionals are executed at instantiation time. The SUS interpreter takes either branch depending on the value of the condition. (See [How SUS is Compiled](how_sus_is_compiled.md))

...
# Roadmap
  ...
  - [Performance, Linking and Name Resolution](performance-linking-and-name-resolution.md)

  - [Safety](safety.md)

  - [Typing & Inference](typing-&-inference.md)

  - [Latency Counting](latency-counting.md)

  - [LSP](lsp.md)

  - [Code Generation](code-generation.md)

  - [Fun projects to do in SUS](fun-projects-to-do-in-sus.md)

  - [Safety through Interface Asserts (PDL-style asserts)](safety-through-interface-asserts-pdl-style-asserts.md)
